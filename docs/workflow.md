...
| Skill | Purpose |
|---|---|
| `brainstorm` | Concept ideation & core loop design |
| `art-bible` | Mood boards, visual style references |
| `game-design-doc` | Vision document templates & guidance |
| `start` | Project onboarding & routing |
...
| Skill | Purpose |
|---|---|
| `game-design-doc` | Game Design Document creation |
| `brainstorm` | Systems design & core loop planning |
| `architecture` | Technical design & system dependencies |
...
| Skill | Purpose |
|---|---|
| `architecture` | Project structure, patterns & tech blueprint |
| `setup-engine` | Godot/Unity/Unreal project setup |
| `sprint-dev` | Task breakdown & development cadence |
...
| `art-bible` | Style guides & visual reference sheets |
| `game-design-doc` | HUD & UX specification |
...
| Skill | Purpose |
|---|---|
| `sprint-dev` | Core game logic, feature delivery & sprints |
| `art-bible` | Character, environment & animation standards |
| `architecture` | Performance optimization & system integrity |
...
| Skill | Purpose |
|---|---|
| `qa-test` | Test plans, bug tracking & quality gates |
| `prototype` | Regression testing & edge case validation |
| `sprint-dev` | Bug fix prioritization & sprint management |
...
| Skill | Purpose |
|---|---|
| `release` | Store setup, certification & launch checklist |
| `qa-test` | Final quality gates & sign-off criteria |
| `sprint-dev` | Patch pipeline & hotfix management |
